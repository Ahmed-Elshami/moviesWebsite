...
export default function Details() {
 ...
 async function goDetails(){
    let {data}=await axios.get(`https://api.themoviedb.org/3/movie/${curentId}?api_key=c636ed7787cc302d96bf88ccf334e0d8`)
    setDetails(data)
  }
  ...
  return (
   ...
   <div className="row">
      ...
      <div className="col-md-8 text-center">
        <h3 className='m-5'>{details.original_title}</h3>
        <h3 className='m-5'>{details.release_date}</h3>
